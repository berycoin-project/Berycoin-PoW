...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("00000000000000000000000000000000000000000000000000000026da225764");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xa756ea1b5da73a740aa4005e1d4558d9c2973f36b6bff0f916891fa7c8dcbd9a"); //1353397
        ...
        vSeeds.emplace_back("dnsseed.berycoin.com", true);
        vSeeds.emplace_back("dnsseed.berycoin.org", true);
        vSeeds.emplace_back("bago.resteemexposure.com", true);
        vSeeds.emplace_back("bilal.myfxstore.com", true);
...
public:
    CTestNetParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {2056, uint256S("fa211189d78247c5173828cdf035a808a69d74294022d0d5d170d707544d7ba8")},
            }
        };
