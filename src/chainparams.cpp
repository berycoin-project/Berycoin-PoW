...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.berycoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.berycointools.com", true);
        vSeeds.emplace_back("dnsseed.berycoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.berycointools.com", true);
        vSeeds.emplace_back("seed-b.berycoin.loshan.co.uk", true);
