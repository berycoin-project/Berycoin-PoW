...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.berycoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.berycointools.com");
        vSeeds.emplace_back("dnsseed.berycoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.berycointools.com");
        vSeeds.emplace_back("seed-b.berycoin.loshan.co.uk");
