...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.berycoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("berycointools.com", "dnsseed.berycointools.com"));
        vSeeds.push_back(CDNSSeedData("berycoinpool.org", "dnsseed.berycoinpool.org"));
